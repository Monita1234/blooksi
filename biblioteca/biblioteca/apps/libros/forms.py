...
class add_autor_form(forms.ModelForm):
	fecha_nacimiento = forms.DateField(widget = forms.TextInput(attrs={'id':'datepicker'}), label='fecha_nacimiento')
	class Meta:
		model 	= Autor
...
class consultar_codigo_form(forms.Form):
		codigo =forms.CharField(max_length = 80)
